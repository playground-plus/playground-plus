...
/* scandir stuff - modern systems all use const struct dirent * */
...
/* Suppress warn_unused_result for calls where we intentionally ignore the
   return value. (void) cast alone doesn't work with GCC's attribute. */
