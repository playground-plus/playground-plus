...
char *get_config_msg(char *type)
{
  ...
  if (!config_msg.where || !*config_msg.where)
  {
    if (!strcasecmp(type, "max_log_size"))	/* ouch */
      return "5000";
    pg_log("error", "Softmsg file for config_msg aint loaded!");
    return "error";
  }
...
char *get_admin_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for admin_msg aint loaded!");
    return "-=*> Erg erg erg";
  }
...
char *get_shutdowns_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for shutdowns_msg aint loaded!");
    return "";
  }
...
char *get_frog_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for frogs_msg aint loaded!");
...
char *get_plists_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for plists_msg aint loaded!");
    return "Erg Erg Erg";
  }
...
char *get_pdefaults_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for pdefaults_msg aint loaded!");
    return "Erg Erg Erg";
  }
...
char *get_session_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for session_msg aint loaded!");
    return "not set";
  }
...
char *get_rooms_msg(char *type)
{
  ...
  {
    pg_log("error", "Softmsg file for rooms_msg aint loaded!");
    return "erg erg erg";
  }
